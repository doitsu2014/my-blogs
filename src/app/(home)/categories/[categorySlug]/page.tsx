    ...
    <div className="flex flex-col items-center min-h-screen p-4 bg-base-100">
      <div className="hero mb-8 bg-base-200 rounded-box p-6">
        <div className="hero-content text-center">
          <div>
            <h1 className="text-3xl font-bold mb-2">Blogs in Category</h1>
          ...
          return (
            <li key={post.id}>
              ...
              <div className="timeline-middle">
                <div className={`p-2 rounded-full ${index % 2 === 0 ? 'bg-primary text-primary-content' : 'bg-secondary text-secondary-content'}`}>
